  ...
  try {
    ...
    if (user.status !== 'ACTIVE') {
      ...
      if (user.status === 'SUSPENDED') {
        errorMessage =
          'Your account has been suspended. Please contact Marine Industry Authority (MARINA) for assistance.';
      } else if (user.status === 'REJECTED') {
        errorMessage =
          'Your account application was rejected. Please contact Marine Industry Authority (MARINA) for more information.';
      } else if (user.status === 'INACTIVE') {
        errorMessage =
          'Your account is pending approval. Please wait for Marine Industry Authority (MARINA) for approval.';
      }
