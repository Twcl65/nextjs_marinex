...
export async function GET(req: NextRequest) {
  try {
    ...
    try {
      ...
      console.error('Error parsing image URL:', parseError, 'URL:', imageUrl)
      return NextResponse.json(
    ...
    // Get region from URL
    const region = getRegionFromUrl(imageUrl)
    ...
    try {
      ...
      // Get the content type from S3 response or default to image
