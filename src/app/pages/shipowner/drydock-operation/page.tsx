    ...
    <SidebarProvider>
      ...
      <SidebarInset>
          ...
          <div className="flex-1">
            <Breadcrumb>
              <BreadcrumbList>
                ...
                <BreadcrumbSeparator />
                <BreadcrumbItem>
                  <BreadcrumbPage>Drydock Operation</BreadcrumbPage>
                </BreadcrumbItem>
              </BreadcrumbList>
            </Breadcrumb>
          </div>
        ...
        <div className="p-3 md:p-4">
          <h1 className="text-xl md:text-2xl font-bold text-[#134686]">Drydock Operation</h1>
          <p className="text-sm text-muted-foreground mt-1">Monitor drydock operations and activities.</p>
        </div>
      </SidebarInset>
    </SidebarProvider>
  )
