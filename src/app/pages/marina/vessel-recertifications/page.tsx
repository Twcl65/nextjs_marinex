  ...
  return (
    ...
    <SidebarProvider>
      ...
      <SidebarInset>
                    ...
                    />
                    <h4 className="text-lg md:text-xl font-bold text-[#134686] mb-0 pl-6 pt-5">Vessel Recertifications</h4>
                    <p className="text-sm text-gray-600 mb-0 pl-6 pt-5">Click the select vessel and fill in the drydock request details.</p>
