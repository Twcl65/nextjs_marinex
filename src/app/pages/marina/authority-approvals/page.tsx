    ...
    <SidebarProvider>
      ...
      <SidebarInset>
        ...
        <div className="p-3 md:p-4">
          <h1 className="text-xl md:text-2xl font-bold text-[#134686]">Authority Approvals</h1>
          <p className="text-sm text-muted-foreground mt-1">Review and approve regulatory submissions and compliance requests.</p>
        </div>
      </SidebarInset>
    </SidebarProvider>
  )
