    ...
    <SidebarProvider>
      ...
      <SidebarInset>
        ...
        <div className="p-3 md:p-4">
          <h1 className="text-xl md:text-2xl font-bold text-[#134686]">Shipyard Bidding</h1>
          <p className="text-sm text-muted-foreground mt-1">Manage shipyard bidding processes and evaluate proposals.</p>
        </div>
      </SidebarInset>
    </SidebarProvider>
  )
